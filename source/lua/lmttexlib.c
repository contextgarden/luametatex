...
static int texlib_getvariablefamilyvalues(lua_State *L)
{
    lua_createtable(L, 0, 2);
    lua_set_string_by_index(L, math_variable_mode_keep,  "keep");
    lua_set_string_by_index(L, math_variable_mode_unset, "unset");
    return 1;
}
...
static const struct luaL_Reg texlib_function_list[] = {
 ...
 // { "checkdelayedglue",              texlib_checkdelayedglue               },
    ...
    { "getvariablefamilyvalues",       texlib_getvariablefamilyvalues        },
